    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                'reservee_type', models.IntegerField(choices=[(1, '学导'), (2, '老师')], default=1, verbose_name='被预约人种类')),
                ('can_reserve_gender', models.IntegerField(choices=[(0, '不限'), (1, '仅限男性'), (2, '仅限女性')], default=0,
                                                           help_text='对于未定义性别的用户只有不限性别选项可被预约',
                                                           verbose_name='可接受预约人性别')),
                ('short_intro', models.TextField(blank=True, null=True, verbose_name='简介（显示于头像下方）')),

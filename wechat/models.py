...
class TemplateMessageTrigger(models.Model):
    ...
    TYPE_CHOICES = (
        ...
        (203, 'TO预约人 - 预约被取消'),
        (204, 'TO预约人 - 预约被确认'),
        (205, 'TO预约人 - 预约已完成'),  # TODO
        (206, 'TO预约人 - 预约被标记为无故未出席'),
        (211, 'TO预约人 - 预约即将开始提醒'),  # TODO
        (301, 'TO被预约人 - 收到预约'),
        (302, 'TO被预约人 - 预约未即时确认提醒'),  # TODO
        (303, 'TO被预约人 - 预约超时取消提醒'),  # TODO
        (304, 'TO被预约人 - 预约完成提醒'),  # TODO
        (311, 'TO被预约人 - 预约即将开始提醒'),  # TODO
    )
